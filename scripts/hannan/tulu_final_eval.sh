#!/bin/bash
#SBATCH --job-name=Rank1024-${MODEL_NAME}-final
#SBATCH --nodes=1        
...
LORA_MODEL_DIR="${BASE_PATH}/tulu3/w_checkpoints/Rank1024"
# MODEL_NAME is passed as an environment variable
LORA_MODEL_DIR="${LORA_MODEL_DIR}/${MODEL_NAME}"
ADAPTER_DIR="${LORA_MODEL_DIR}/final/"
